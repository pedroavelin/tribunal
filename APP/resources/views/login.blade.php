    ...
    <div class="authentication-inner row m-0">
      ...
      <div class="d-flex col-12 col-xl-4 align-items-center authentication-bg p-sm-12 p-6">
        <div class="w-px-400 mx-auto mt-12 pt-5">
          ...
          <form id="formAuthentication" class="mb-6" action="{{route('home')}}" method="GET">
            ...
            <button onclick="window.location.href='{{ url('home') }}'"  class="btn btn-primary d-grid w-100">Sign in</button>
          </form>
