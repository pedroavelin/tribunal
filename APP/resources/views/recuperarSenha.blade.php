...
<head>
    ...
    <title>Demo: Forgot Password Basic - Pages | Vuexy - Bootstrap Dashboard PRO</title>
            ...
            <div class="authentication-inner py-6">
                ...
                <div class="card">
                    <div class="card-body">
                        ...
                        <form id="formAuthentication" class="mb-6" action="{{ route('login')}}" method="GET">
                            <div class="mb-6 form-control-validation">
                                <label for="email" class="form-label">Email</label>
                                <input type="text" class="form-control" id="email" name="email"
                                    placeholder="Enter your email" autofocus="">
                            </div>
                            <button onclick="window.location.href='{{ url('resetPassWord') }}'" class="btn btn-primary d-grid w-100">Send Reset Link</button>
                        </form>
