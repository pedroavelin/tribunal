  ...
  <div class="breadcrumbs">
    <div class="container">
      <div class="row">
        <div class="col-xs-12">
          <ul>
            <li class="home"> <a title="Go to Home Page" href="#!">Início</a><span>&raquo;</span></li>
  ...
  <div class="main container">
    ...
    <div class="about-page">
       <div class="col-xs-12 col-sm-6"> 
         ...
         <h1>Sobre <span class="text_color">JJ</span></h1>
      ...
      <div class="row">
        <div class="col-xs-6 col-sm-3 col-md-3">
          <div class="wow bounceInUp" data-wow-delay="0.2s">
            <div class="team">
              <div class="inner">
                <div class="avatar"><img src="{{asset('assets/images/team-img01.jpg')}}" alt="" class="img-responsive img-circle" /></div>
                <h5>Joana Doe</h5>
        ...
        <div class="col-xs-6 col-sm-3 col-md-3">
          <div class="wow bounceInUp" data-wow-delay="0.5s">
            <div class="team">
              <div class="inner">
                <div class="avatar"><img src="{{asset('assets/images/team-img03.jpg')}}" alt="" class="img-responsive img-circle" /></div>
                <h5>Josefine</h5>
          ...
          <div class="slider-items-products">
            <div id="our-clients-slider" class="product-flexslider hidden-buttons">
              <div class="slider-items slider-width-col6"> 
                ...
                <!-- Item -->
                <div class="item"> <a href="#"><img src="{{asset('assets/images/brand1.png')}}" alt="Image"></a> <a href="#"><img src="{{asset('assets/images/brand2.png')}}" alt="Image"></a> </div>
                <!-- End Item --> 
                
                <!-- Item -->
                <div class="item"> <a href="#"><img src="{{asset('assets/images/brand3.png')}}" alt="Image"></a> <a href="#"><img src="{{asset('assets/images/brand4.png')}}" alt="Image"></a> </div>
                <!-- End Item --> 
                
                <!-- Item -->
                <div class="item"> <a href="#"><img src="{{asset('assets/images/brand5.png')}}" alt="Image"></a> <a href="#"><img src="{{asset('assets/images/brand6.png')}}" alt="Image"></a> </div>
                <!-- End Item --> 
                
                <!-- Item -->
                <div class="item"> <a href="#"><img src="{{asset('assets/images/brand7.png')}}" alt="Image"></a> <a href="#"><img src="{{asset('assets/images/brand3.png')}}" alt="Image"></a> </div>
                <!-- End Item --> 
