        ...
        <div class="row profile-wrapper">
          <div class="col-xs-12 col-md-3 col-lg-2 profile-left">
            <div class="profile-left-heading">
              ...
              <RouterLink class="profile-photo"><img class="img-circle img-responsive" src="@/assets/images/avatar.png" alt=""></RouterLink>
              <h2 class="profile-name">Elen Adarna</h2>
                    ...
                    <div class="panel-heading">
                      <div class="media">
                        <div class="media-left">
                          <a href="#">
                            <img alt="" src="@/assets/images/avatar.png" class="media-object img-circle">
                          </a>
                        </div>
                  ...
                  <div class="panel panel-post-item">
                    ...
                    <div class="panel-body nopaddingbottom">
                      <div class="media">
                        <div class="media-left">
                          <a href="#">
                            <img class="media-object width80" src="@/assets/images/avatar.png" alt="">
                          </a>
                        </div>
                        <div class="media-body">
