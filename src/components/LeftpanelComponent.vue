  ...
  <div class="leftpanelinner">
    ...
    <div class="media leftpanel-profile">
      <div class="media-left">
        <a href="#">
          <img src="@/assets/images/avatar.png" alt="" class="media-object img-circle">
        </a>
      </div>
      <div class="media-body">
        <h4 class="media-heading">Elen Adarna <a data-toggle="collapse" data-target="#loguserinfo" class="pull-right"><i class="glyphicon glyphicon-eye-open"></i></a></h4>
    ...
    <ul class="nav nav-tabs nav-justified nav-sidebar">
      <li class="tooltips active" data-toggle="tooltip" title="Main Menu"><a data-toggle="tab" data-target="#mainmenu"><i class="glyphicon glyphicon-option-horizontal"></i></a></li>
      ...
      <li class="tooltips" data-toggle="tooltip" title="Sair"><RouterLink to="/"><i class="glyphicon glyphicon-log-out"></i></RouterLink></li>
    </ul>
    ...
    <div class="tab-content">
      ...
      <div class="tab-pane active" id="mainmenu">
        ...
        <ul class="nav nav-pills nav-stacked nav-quirk">
          <li class="active"><RouterLink to="/home"><i class="glyphicon glyphicon-th-large"></i> <span>Dashboard</span></RouterLink></li>
          <li><RouterLink to="/tribunal" ><span class="badge pull-right">10+</span><i class="glyphicon glyphicon-home"></i>  <span>Tribunal</span></RouterLink></li>
          <li><RouterLink to="/seccoes"><span class="badge pull-right">99+</span><i class="glyphicon glyphicon-fullscreen"></i> <span>Secção</span></RouterLink></li>
          <li><RouterLink to="/processo"><span class="badge pull-right">10+</span><i class="glyphicon glyphicon-folder-open"></i> <span>Processo</span></RouterLink></li>
        </ul>

        <h5 class="sidebar-title">Gestão</h5>
        <ul class="nav nav-pills nav-stacked nav-quirk">
          <li class="nav-parent">
            <RouterLink to="/utilizador"><i class="glyphicon glyphicon-user"></i> <span>Utilizador</span></RouterLink>
            <ul class="children">
              <li><a href="general-forms.html">Papeis</a></li>
              <li><a href="form-validation.html">Form Validation</a></li>
              <li><a href="form-wizards.html">Form Wizards</a></li>
              <li><a href="wysiwyg.html">Text Editor</a></li>
            </ul>
          </li>
          <li class="nav-parent"><RouterLink to="/papel"><i class="glyphicon glyphicon-list-alt"></i> <span>Papeis</span></RouterLink>
            <ul class="children">
          ...
          <li class="nav-parent" style="display:none"><a href=""><i class="fa fa-th-list"></i> <span>Tables</span></a>
            <ul class="children">
              <li><a href="basic-tables.html">Basic Tables</a></li>
              <li><a href="data-tables.html">Data Tables</a></li>
            </ul>
          </li>
          <li class="nav-parent" style="display:none"><a href=""><i class="fa fa-file-text"></i> <span>Pages</span></a>
            <ul class="children">
      ...
      <div class="tab-pane" id="contactmenu">
        ...
        <ul class="media-list media-list-contacts">
          <li class="media">
            <a href="#">
              <div class="media-left">
                  <img class="media-object img-circle" src="@/assets/images/avatar.png" alt="">
              </div>
              <div class="media-body">
