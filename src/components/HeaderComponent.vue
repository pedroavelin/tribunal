<template>
  <header>
    <div class="headerpanel">
      ...
      <div class="logopanel">
        <h2><RouterLink to="/home">TRIBUNAL-X</RouterLink></h2>
      </div><!-- logopanel -->

      <div class="headerbar">

        <a id="menuToggle" class="menutoggle"><i class="glyphicon glyphicon-align-justify"></i></a>
            ...
            <li>
              <div class="btn-group">
                <button type="button" class="btn btn-logged" data-toggle="dropdown">
                  <img src="@/assets/images/avatar.png" alt=""/>Elen Adarna<span class="caret"></span>
                </button>
                <ul class="dropdown-menu pull-right">
                  <li><RouterLink to="/perfil"><i class="glyphicon glyphicon-user"></i> Meu Perfil</RouterLink></li>
                  <li><a href="#"><i class="glyphicon glyphicon-cog"></i> Definições da conta</a></li>
                  <li><a href="#"><i class="glyphicon glyphicon-question-sign"></i> Ajuda</a></li>
                  <li><RouterLink to="/" class="glyphicon glyphicon-log-out"> Sair</RouterLink></li>
                </ul>
              </div>
            </li>
            <!-- <li>
